...
#jupyter nbconvert --execute --to notebook --inplace 4b4_BCC4_planning_repetition_data_cross_fitting_MFMB4_mb_mf.ipynb
#jupyter nbconvert --execute --to notebook --inplace 4b5_BCC4_planning_repetition_data_cross_fitting_MFMB6_mb_mf_prior.ipynb
jupyter nbconvert --execute --to notebook --inplace 5b_inference_BCC4_planning_repetition.ipynb